...
(function (A09_Asteroids) {
    A09_Asteroids.shapesAsteroids = [
        ...
        [
            [39, 0], [68, 7], [86, 31], [88, 70], [53, 58], [54, 96], [26, 91], [28, 76], [2, 56], [15, 19]
        ],
        [
    ...
    function createPaths() {
        A09_Asteroids.asteroidPaths = createAsteroidsPaths(A09_Asteroids.shapesAsteroids);
        // ufoPath = createUfoPath();
    }
    A09_Asteroids.createPaths = createPaths;
    function createAsteroidsPaths(_shapes) {
        let paths = [];
